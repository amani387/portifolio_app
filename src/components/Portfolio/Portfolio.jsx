...
<img src={image} alt={title}/>
          ...
          <a href={github} className="btn" rel="github_account" target="_blank">Github</a>
          <a href={demo} className="btn btn-primary" rel="github_account" target="_blank">Live Demo</a>  
          </div>
        </article>
